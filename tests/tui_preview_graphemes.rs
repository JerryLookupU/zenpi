...
fn approval_preview_keeps_character_after_wide_emoji_visible_without_allowing() {
    ...
    // ZS1-182 staged confirm: a bare Enter opens the reject-feedback stage
    // rather than denying outright, so the denial is the second Enter.  What
    // this test is about — the wide emoji staying visible while the draft

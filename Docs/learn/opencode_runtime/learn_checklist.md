# Learn Checklist — opencode_agent_runtime

Derived ledger for subset `opencode_agent_runtime` (61 source files, 8 folders).
`Docs/learn/opencode_runtime/subsets/opencode_agent_runtime/source_manifest.tsv` is the only coverage truth.
